...
public class BadPatchModel extends GeoModel<BadPatchEntity> {
    ...
    public ResourceLocation getModelResource(BadPatchEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(KnightQuestCommon.MOD_ID, "geo/bad_patch.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(BadPatchEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(KnightQuestCommon.MOD_ID, "textures/entity/bad_patch.png");
    }

    @Override
    public ResourceLocation getAnimationResource(BadPatchEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(KnightQuestCommon.MOD_ID, "animations/bad_patch.animation.json");
    }

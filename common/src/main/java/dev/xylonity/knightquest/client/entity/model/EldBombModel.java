...
public class EldBombModel extends GeoModel<EldBombEntity> {
    private static final ResourceLocation DEFAULT_TEXTURE = ResourceLocation.fromNamespaceAndPath(KnightQuestCommon.MOD_ID, "textures/entity/eldbomb.png");
    private static final ResourceLocation WHITE_TEXTURE = ResourceLocation.fromNamespaceAndPath(KnightQuestCommon.MOD_ID, "textures/entity/eldbomb_white.png");

    @Override
    public ResourceLocation getModelResource(EldBombEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(KnightQuestCommon.MOD_ID, "geo/eldbomb.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(EldBombEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(KnightQuestCommon.MOD_ID, "animations/eldbomb.animation.json");
    }

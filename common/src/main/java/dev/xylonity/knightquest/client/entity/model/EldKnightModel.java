...
public class EldKnightModel extends GeoModel<EldKnightEntity> {
    ...
    public ResourceLocation getModelResource(EldKnightEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(KnightQuestCommon.MOD_ID, "geo/eldknight.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(EldKnightEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(KnightQuestCommon.MOD_ID, "textures/entity/eldknight.png");
    }

    @Override
    public ResourceLocation getAnimationResource(EldKnightEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(KnightQuestCommon.MOD_ID, "animations/eldknight.animation.json");
    }

...
public class GhostyModel extends GeoModel<GhostyEntity> {
    ...
    public ResourceLocation getModelResource(GhostyEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(KnightQuestCommon.MOD_ID, "geo/ghosty.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(GhostyEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(KnightQuestCommon.MOD_ID, "textures/entity/ghosty.png");
    }

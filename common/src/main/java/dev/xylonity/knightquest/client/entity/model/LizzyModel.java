...
public class LizzyModel extends GeoModel<LizzyEntity> {
    ...
    public ResourceLocation getModelResource(LizzyEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(KnightQuestCommon.MOD_ID, "geo/lizzy.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(LizzyEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(KnightQuestCommon.MOD_ID, "textures/entity/lizzy.png");
    }

    @Override
    public ResourceLocation getAnimationResource(LizzyEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(KnightQuestCommon.MOD_ID, "animations/lizzy.animation.json");
    }

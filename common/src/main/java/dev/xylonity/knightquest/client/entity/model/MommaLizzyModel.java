...
public class MommaLizzyModel extends GeoModel<MommaLizzyEntity> {
    ...
    public ResourceLocation getModelResource(MommaLizzyEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(KnightQuestCommon.MOD_ID, "geo/momma_lizzy.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(MommaLizzyEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(KnightQuestCommon.MOD_ID, "textures/entity/momma_lizzy.png");
    }

    @Override
    public ResourceLocation getAnimationResource(MommaLizzyEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(KnightQuestCommon.MOD_ID, "animations/momma_lizzy.animation.json");
    }

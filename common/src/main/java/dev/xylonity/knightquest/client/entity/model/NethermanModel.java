...
public class NethermanModel extends GeoModel<NethermanEntity> {
    ...
    public ResourceLocation getModelResource(NethermanEntity animatable) {
        ...
        if (animatable.isDeadOrDying())
            return ResourceLocation.fromNamespaceAndPath(KnightQuestCommon.MOD_ID, "geo/netherman_magic.geo.json");
        ...
        return ResourceLocation.fromNamespaceAndPath(KnightQuestCommon.MOD_ID, path);
    }
    ...
    public ResourceLocation getTextureResource(NethermanEntity animatable) {
        ...
        if (animatable.isDeadOrDying())
            return ResourceLocation.fromNamespaceAndPath(KnightQuestCommon.MOD_ID, TEXTURE_PATH + "netherman_magic.png");
    ...
    public ResourceLocation getAnimationResource(NethermanEntity animatable) {
        ...
        if (animatable.isDeadOrDying())
            return ResourceLocation.fromNamespaceAndPath(KnightQuestCommon.MOD_ID, "animations/netherman_magic.animation.json");
        ...
        if (animatable.getCounterSwitchPhase2() == 130 && animatable.getPhase() == 2
            ...
            return ResourceLocation.fromNamespaceAndPath(KnightQuestCommon.MOD_ID, "animations/netherman_ice.animation.json");
        } else if (animatable.getCounterSwitchPhase3() == 160 && animatable.getPhase() == 3) {
            return ResourceLocation.fromNamespaceAndPath(KnightQuestCommon.MOD_ID, "animations/netherman_magic.animation.json");
        }

        return ResourceLocation.fromNamespaceAndPath(KnightQuestCommon.MOD_ID, "animations/netherman_fire.animation.json");
    }

...
public class SamhainModel extends GeoModel<SamhainEntity> {
    ...
    public ResourceLocation getModelResource(SamhainEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(KnightQuestCommon.MOD_ID, "geo/samhain.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(SamhainEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(KnightQuestCommon.MOD_ID, "animations/samhain.animation.json");
    }

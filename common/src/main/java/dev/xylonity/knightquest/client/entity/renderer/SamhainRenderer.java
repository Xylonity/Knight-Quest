...
public class SamhainRenderer extends GeoEntityRenderer<SamhainEntity> {
    ...
    public @NotNull ResourceLocation getTextureLocation(@NotNull SamhainEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(KnightQuestCommon.MOD_ID, "textures/entity/samhain.png");
    }
    ...
    @Override
    public void preRender(PoseStack poseStack, SamhainEntity animatable, BakedGeoModel model, @Nullable MultiBufferSource bufferSource, @Nullable VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {

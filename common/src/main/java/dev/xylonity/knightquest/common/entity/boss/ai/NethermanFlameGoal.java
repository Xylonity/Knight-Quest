        ...
        if (livingentity != null) {
            if (livingentity.distanceToSqr(this.netherman) < 4096.0D && this.netherman.hasLineOfSight(livingentity)) {
                ...
                if (chargeTime == 5) {
                    ...
                    this.netherman.getTarget().setRemainingFireTicks(this.netherman.getTarget().getRandom().nextInt(KQConfigValues.FIRE_ATTACK_MIN_TIME.get(), KQConfigValues.FIRE_ATTACK_MAX_TIME.get()) * 20);
                }

...
public class KnightQuestItems {
    ...
    private static <T extends Item> Supplier<T> registerArmorItem(String id, Holder<ArmorMaterial> armorMaterial, ArmorItem.Type armorType, boolean containsTooltip) {
        return KnightQuestCommon.COMMON_PLATFORM.registerArmorItem(id, armorMaterial, armorType, containsTooltip);
    }

    private static <T extends Item> Supplier<T> registerGeoArmorItem(String id, Holder<ArmorMaterial> armorMaterial, ArmorItem.Type armorType, boolean containsTooltip, boolean containsExtraTooltip) {

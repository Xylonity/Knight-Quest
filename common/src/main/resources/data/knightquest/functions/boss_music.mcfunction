...
execute as @a at @s unless entity @e[type=knightquest:netherman,distance=..130] run stopsound @s record knightquest:the_architect_of_chaos
...
execute as @a at @s if score @s nethermantheme matches 3620.. run scoreboard players set @s nethermantheme 2

execute as @a at @s if score @s nethermantheme matches 2 run playsound knightquest:the_architect_of_chaos record @s ~ ~ ~ 0.7
execute as @a at @s if score @s nethermantheme matches 2 run scoreboard players set @s nethermantheme 3
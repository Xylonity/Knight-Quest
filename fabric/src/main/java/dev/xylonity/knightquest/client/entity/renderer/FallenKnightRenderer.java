...
public class FallenKnightRenderer extends GeoEntityRenderer<FallenKnightEntity> {
    ...
    public @NotNull ResourceLocation getTextureLocation(@NotNull FallenKnightEntity animatable) {
        return new ResourceLocation(KnightQuest.MOD_ID, "textures/entity/fallenknight.png");
    }

    @Override
    public void preRender(PoseStack poseStack, FallenKnightEntity animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {

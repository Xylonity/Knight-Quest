...
public class KnightQuestWeapons {
    ...
    public static final Item CLEAVER = register("cleaver", () -> new CleaverWeapon(KQItemMaterials.CLEAVER, new Item.Properties().fireResistant().attributes(SwordItem.createAttributes(KQItemMaterials.CLEAVER, -1, -3.2f))));

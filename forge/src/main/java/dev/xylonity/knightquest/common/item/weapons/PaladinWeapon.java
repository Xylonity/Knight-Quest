...
public class PaladinWeapon extends KQWeaponItem {
    ...
    public void interaction(Level level, Player player, InteractionHand hand) {
        player.addEffect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, KQConfigValues.INV_TICKS_PALADIN, 5, false, false));
    }

    @Override
    public int getCooldownTicks() {
        return KQConfigValues.COOLDOWN_PALADIN;
    }

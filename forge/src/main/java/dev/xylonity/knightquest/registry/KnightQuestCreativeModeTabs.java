            ...
            CREATIVE_MODE_TABS.register("knightquest_tab",
                    () -> CreativeModeTab.builder()
                            ...
                            .displayItems((itemDisplayParameters, output) -> {
                                ...
                                output.accept(KnightQuestEntities.GREMLIN_EGG.get());
                                output.accept(KnightQuestEntities.ELD_KNIGHT_EGG.get());
                                output.accept(KnightQuestEntities.ELD_BOMB_EGG.get());
                                output.accept(KnightQuestEntities.SAMHAIN_EGG.get());
                                output.accept(KnightQuestEntities.SWAMPMAN_EGG.get());
                                output.accept(KnightQuestEntities.RATMAN_EGG.get());
                                output.accept(KnightQuestEntities.LIZZY_EGG.get());
                                output.accept(KnightQuestEntities.BADPATCH_EGG.get());
                                output.accept(KnightQuestEntities.GHOSTY_EGG.get());
                                //output.accept(KnightQuestItems.GHASTLING_EGG.get());
                                //output.accept(KnightQuestItems.MOMMA_LIZZY_EGG.get());
                                output.accept(KnightQuestEntities.NETHERMAN_EGG.get());

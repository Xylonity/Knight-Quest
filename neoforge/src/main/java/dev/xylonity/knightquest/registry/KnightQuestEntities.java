...
public class KnightQuestEntities {
    ...
    private static <X extends Mob> DeferredHolder<Item, DeferredSpawnEggItem> registerSpawnEggItem(String id, Supplier<EntityType<X>> entityType, int primaryEggColour, int secondaryEggColour) {
        return KnightQuest.ITEMS.register(id, () -> new DeferredSpawnEggItem(entityType, primaryEggColour, secondaryEggColour, new Item.Properties()));
    }

    public static final DeferredHolder<Item, DeferredSpawnEggItem> GREMLIN_EGG = registerSpawnEggItem("gremlin_spawn_egg", KnightQuestEntities.GREMLIN, 0xc22f26, 0x45545d);
    public static final DeferredHolder<Item, DeferredSpawnEggItem> ELD_BOMB_EGG = registerSpawnEggItem("eldbomb_spawn_egg", KnightQuestEntities.ELDBOMB, 0x43404e, 0x81da25);
    public static final DeferredHolder<Item, DeferredSpawnEggItem> ELD_KNIGHT_EGG = registerSpawnEggItem("eldknight_spawn_egg", KnightQuestEntities.ELDKINGHT, 0x7f8ab2, 0x8a392e);
    public static final DeferredHolder<Item, DeferredSpawnEggItem> RATMAN_EGG = registerSpawnEggItem("ratman_spawn_egg", KnightQuestEntities.RATMAN, 0x3a303d, 0xb75383);
    public static final DeferredHolder<Item, DeferredSpawnEggItem> SAMHAIN_EGG = registerSpawnEggItem("samhain_spawn_egg", KnightQuestEntities.SAMHAIN, 0xfdde03, 0x982938);
    public static final DeferredHolder<Item, DeferredSpawnEggItem> SWAMPMAN_EGG = registerSpawnEggItem("swampman_spawn_egg", KnightQuestEntities.SWAMPMAN, 0x108773, 0x9e304f);
    public static final DeferredHolder<Item, DeferredSpawnEggItem> LIZZY_EGG = registerSpawnEggItem("lizzy_spawn_egg", KnightQuestEntities.LIZZY, 0x0babf2, 0xd1802b);
    public static final DeferredHolder<Item, DeferredSpawnEggItem> BADPATCH_EGG = registerSpawnEggItem("bad_patch_spawn_egg", KnightQuestEntities.BADPATCH, 0xec160b, 0xeff1f8);
    public static final DeferredHolder<Item, DeferredSpawnEggItem> GHOSTY_EGG = registerSpawnEggItem("ghosty_spawn_egg", KnightQuestEntities.GHOSTY, 0x2cb87e, 0xfbe105);
    public static final DeferredHolder<Item, DeferredSpawnEggItem> NETHERMAN_EGG = registerSpawnEggItem("netherman_spawn_egg", KnightQuestEntities.NETHERMAN, 0xebedec, 0xc3c3c3);
    public static final DeferredHolder<Item, DeferredSpawnEggItem> MOMMA_LIZZY_EGG = registerSpawnEggItem("momma_lizzy_spawn_egg", KnightQuestEntities.MOMMA_LIZZY, 0x0babf2, 0x9f5b14);

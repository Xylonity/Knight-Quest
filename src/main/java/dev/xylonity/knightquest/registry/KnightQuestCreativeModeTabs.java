...
public class KnightQuestCreativeModeTabs {
    ...
    public static final RegistryObject<CreativeModeTab> KNIGHTQUEST_TAB =
            CREATIVE_TABS.register("knightquest_tab",
                    () -> CreativeModeTab.builder()
                            ...
                            .displayItems((itemDisplayParameters, output) -> {
                                ...
                                output.accept(KnightQuestItems.NAIL.get());
                                ...
                                //output.accept(KnightQuestWeapons.CRIMSON_SWORD.get());
                                //output.accept(KnightQuestWeapons.WATER_SWORD.get());
                                ...
                                output.accept(KnightQuestItems.FALLEN_KNIGHT_EGG.get());

...
public class KnightQuestItems {
    ...
    public static final RegistryObject<Item> RADIANT_ESSENCE = ITEMS.register("radiant_essence", () -> new KnightQuestItem(new Item.Properties(), "radiant_essence"));
    public static final RegistryObject<Item> CHAOTIC_ESSENCE = ITEMS.register("chaotic_essence", () -> new KnightQuestItem(new Item.Properties(), "radiant_essence"));
    public static final RegistryObject<Item> EMPTY_GOBLET = ITEMS.register("empty_goblet", () -> new KnightQuestItem(new Item.Properties(), "empty_goblet"));
    public static final RegistryObject<Item> FILLED_GOBLET = ITEMS.register("filled_goblet", () -> new KnightQuestItem(new Item.Properties(), "filled_goblet"));
    public static final RegistryObject<Item> RATMAN_EYE = ITEMS.register("ratman_eye", () -> new KnightQuestItem(new Item.Properties(), "ratman_eye"));
    public static final RegistryObject<Item> LIZZY_SCALE = ITEMS.register("lizzy_scale", () -> new KnightQuestItem(new Item.Properties(), "lizzy_scale"));

    public static final RegistryObject<Item> THE_ARCHITECT_OF_CHAOS_DISC = registerMusicDisc("music_disc_the_architect_of_chaos", 6, KnightQuestSounds.THE_ARCHITECT_OF_CHAOS, new Item.Properties().stacksTo(1).rarity(Rarity.EPIC).fireResistant(), 3540);

    public static final RegistryObject<Item> STEEL_SWORD = registerSwordItem("steel_sword", KQItemMaterials.STEEL_SWORD, new Item.Properties(), -2.4f, false);
    public static final RegistryObject<Item> STEEL_AXE = registerAxeItem("steel_axe", KQItemMaterials.STEEL_SWORD, new Item.Properties(), 4f, -3f);

    public static final RegistryObject<Item> PALADIN_SWORD = ITEMS.register("paladin_sword", () -> new PaladinWeapon(KQItemMaterials.PALADIN, new Item.Properties().fireResistant().attributes(SwordItem.createAttributes(KQItemMaterials.PALADIN, -1, -2.6f))));
    public static final RegistryObject<Item> NAIL = ITEMS.register("nail_glaive", () -> new NailWeapon(KQItemMaterials.NAIL, new Item.Properties().fireResistant().attributes(SwordItem.createAttributes(KQItemMaterials.NAIL, -1, -2.4f))));
    public static final RegistryObject<Item> UCHIGATANA = ITEMS.register("uchigatana_katana", () -> new UchigatanaWeapon(KQItemMaterials.UCHIGATANA, new Item.Properties().fireResistant().attributes(SwordItem.createAttributes(KQItemMaterials.UCHIGATANA, -1, -2.2f))));
    public static final RegistryObject<Item> KUKRI = ITEMS.register("kukri_dagger", () -> new KukriWeapon(KQItemMaterials.KUKRI, new Item.Properties().attributes(SwordItem.createAttributes(KQItemMaterials.KUKRI, -1, -1f))));
    public static final RegistryObject<Item> KHOPESH = ITEMS.register("khopesh_claymore", () -> new KhopeshWeapon(KQItemMaterials.KHOPESH, new Item.Properties().fireResistant().attributes(SwordItem.createAttributes(KQItemMaterials.KHOPESH, -1, -2.6f))));
    public static final RegistryObject<Item> CLEAVER = ITEMS.register("cleaver", () -> new CleaverWeapon(KQItemMaterials.CLEAVER, new Item.Properties().fireResistant().attributes(SwordItem.createAttributes(KQItemMaterials.CLEAVER, -1, -3.2f))));
    ...
    public static final RegistryObject<Item> BAMBOO_BLUE_HELMET = ITEMS.register("bamboo_blue_helmet",
            () -> new GeoItemArmor(KQArmorMaterials.BAMBOOSET_BLUE, ArmorItem.Type.HELMET, new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(40))
                    , "textures/armor/bamboo_blue_helmet.png", "geo/bamboo_blue_helmet.geo.json"));
    ...
    public static final RegistryObject<Item> BAMBOO_GREEN_HELMET = ITEMS.register("bamboo_green_helmet",
            () -> new GeoItemArmor(KQArmorMaterials.BAMBOOSET_GREEN, ArmorItem.Type.HELMET, new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(40))
                    , "textures/armor/bamboo_green_helmet.png", "geo/bamboo_green_helmet.geo.json"));
    ...
    public static final RegistryObject<Item> FORZE_CHESTPLATE = ITEMS.register("forze_chestplate",
            () -> new GeoItemArmor(KQArmorMaterials.FORZESET, ArmorItem.Type.CHESTPLATE, new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(40))
                    , "textures/armor/forze_chestplate.png", "geo/forze_chestplate.geo.json"));
    ...
    public static final RegistryObject<Item> VETERAN_CHESTPLATE = ITEMS.register("veteran_chestplate",
            () -> new GeoItemArmor(KQArmorMaterials.VETERANSET, ArmorItem.Type.CHESTPLATE, new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(40))
                    , "textures/armor/veteran_chestplate.png", "geo/veteran_chestplate.geo.json"));
    ...
    public static final RegistryObject<Item> SILVER_CHESTPLATE = ITEMS.register("silver_chestplate",
            () -> new GeoItemArmor(KQArmorMaterials.SILVERSET, ArmorItem.Type.CHESTPLATE, new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(35))
                    , "textures/armor/silver_chestplate.png", "geo/silver_chestplate.geo.json"));
    ...
    public static final RegistryObject<Item> SPIDER_CHESTPLATE = ITEMS.register("spider_chestplate",
            () -> new GeoItemArmor(KQArmorMaterials.SPIDERSET, ArmorItem.Type.CHESTPLATE, new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(35))
                    , "textures/armor/spider_chestplate.png", "geo/spider_chestplate.geo.json"));
    ...
    public static final RegistryObject<Item> FALLEN_KNIGHT_EGG = ITEMS.register("fallen_knight_spawn_egg",
            () -> new ForgeSpawnEggItem(KnightQuestEntities.GHOSTY, 0x2cb87e, 0xfbe105, new Item.Properties()));
    ...
    private static <T extends Item> RegistryObject<T> registerSwordItem(String id, KQItemMaterials itemMaterial, Item.Properties properties, float speedMalus, boolean containsTooltip) {
        if (containsTooltip)
            return (RegistryObject<T>) ITEMS.register(id, () -> new SwordItem(itemMaterial, properties.attributes(SwordItem.createAttributes(itemMaterial, 4, speedMalus))) {
                @Override
    ...
    private static <T extends Item> RegistryObject<T> registerAxeItem(String id, KQItemMaterials itemMaterial, Item.Properties properties, float extraDamageBoost, float speedMalus) {
        return (RegistryObject<T>) ITEMS.register(id, () -> new AxeItem(itemMaterial, properties.attributes(AxeItem.createAttributes(itemMaterial, extraDamageBoost, speedMalus))));
    }

    private static <T extends Item> RegistryObject<T> registerMusicDisc(String id, int signal, Supplier<SoundEvent> soundEvent, Item.Properties properties, int length) {
        return (RegistryObject<T>) registerItem(id, () -> new Item(properties.jukeboxPlayable(ResourceKey.create(Registries.JUKEBOX_SONG, ResourceLocation.fromNamespaceAndPath(KnightQuest.MOD_ID, "the_architect_of_chaos")))));
    }

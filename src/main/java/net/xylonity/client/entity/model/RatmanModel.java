...
public class RatmanModel extends GeoModel<RatmanEntity> {
    ...
    public Identifier getModelResource(RatmanEntity animatable) {
        return Identifier.of(KnightQuest.MOD_ID, "geo/ratman.geo.json");
    }

    @Override
    public Identifier getTextureResource(RatmanEntity animatable) {
        return Identifier.of(KnightQuest.MOD_ID, "textures/entity/ratman" + animatable.getVariation() + ".png");
    }

    @Override
    public Identifier getAnimationResource(RatmanEntity animatable) {
        return Identifier.of(KnightQuest.MOD_ID, "animations/ratman.animation.json");
    }

...
public class AbstractNethermanProjectile extends ProjectileEntity {
    ...
    protected AbstractNethermanProjectile(EntityType<? extends AbstractNethermanProjectile> entityType, World world) {
        super(entityType, world);
    }

    public AbstractNethermanProjectile(EntityType<? extends AbstractNethermanProjectile> type, double x, double y, double z, double directionX, double directionY, double directionZ, World world) {
        this(type, world);
    ...
    public AbstractNethermanProjectile(EntityType<? extends AbstractNethermanProjectile> type, LivingEntity owner, double directionX, double directionY, double directionZ, World world) {

...
public class NethermanAttackGoal extends Goal {
    protected final NethermanEntity mob;
    ...
    public NethermanAttackGoal(NethermanEntity pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen) {
        this.mob = pMob;

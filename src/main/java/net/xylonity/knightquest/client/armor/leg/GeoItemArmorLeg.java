...
public class GeoItemArmorLeg extends GeoArmorItem implements IAnimatable {
    ...
    public GeoItemArmorLeg(KQArmorMaterials material, EquipmentSlot type, Properties properties, String textureResource, String modelResource) {

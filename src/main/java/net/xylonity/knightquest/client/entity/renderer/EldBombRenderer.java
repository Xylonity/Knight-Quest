...
public class EldBombRenderer extends GeoEntityRenderer<EldBombEntity> {
    ...
    @Override
    public void render(EldBombEntity entity, float entityYaw, float partialTick, @NotNull PoseStack poseStack, @NotNull MultiBufferSource bufferSource, int packedLight) {

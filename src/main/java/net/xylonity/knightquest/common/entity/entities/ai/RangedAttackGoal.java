...
public class RangedAttackGoal<T extends net.minecraft.world.entity.Mob & RangedAttackMob> extends Goal {
    private final T mob;
    ...
    public boolean canContinueToUse() {
        return (this.canUse() || !this.mob.getNavigation().isDone()) && this.isHoldingRangedWeapon();
    }
        ...
        if (livingentity != null) {
            ...
            if (this.mob.isUsingItem()) {
                if (!flag && this.seeTime < -60) {
                    ...
                    if (i >= 20) {
                        this.mob.stopUsingItem();
                        this.mob.performRangedAttack(livingentity, this.getPowerForTime(i));

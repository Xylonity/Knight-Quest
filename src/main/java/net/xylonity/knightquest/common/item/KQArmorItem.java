    ...
    public class ArmorStatusManagerEvents {
        ...
        public static void onLivingHurt(LivingHurtEvent event) {
            ...
            if (event.getEntity() instanceof Player player) {
                ...
                if (KQFullSetChecker.hasFullSuitOfArmorOn(player, KQArmorMaterials.EVOKERSET)) {
                    ...
                    if (event.getSource().getEntity() != null && event.getSource().getEntity() instanceof LivingEntity entity && random.nextFloat() < 0.15)
                        entity.addEffect(new MobEffectInstance(MobEffects.BLINDNESS, 160, 0, false, false, true));
                }
            ...
            if (event.getSource().getEntity() instanceof Player player && event.getEntity() != null) {
                ...
                if (KQFullSetChecker.hasFullSuitOfArmorOn(player, KQArmorMaterials.HOLLOWSET) && event.getEntity() instanceof LivingEntity livingEntity)
                    player.heal(Math.min((float) (event.getAmount() * 0.15), livingEntity.getHealth()));
                ...
                if (event.getSource().isProjectile() && KQFullSetChecker.hasFullSuitOfArmorOn(player, KQArmorMaterials.WITHERSET)) {
                    Random random = new Random();
                    if (event.getSource().getEntity() != null && random.nextFloat() < 0.3 && event.getSource().getEntity() instanceof LivingEntity livingEntity)
                        livingEntity.addEffect(new MobEffectInstance(MobEffects.WITHER, 100, 0, false, false, false));
                }
            }
        }
        ...
        @SubscribeEvent
        public static void onArrowHit(EntityJoinWorldEvent event) {

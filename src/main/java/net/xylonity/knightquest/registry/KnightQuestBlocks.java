...
public class KnightQuestBlocks {
    ...
    public static final DeferredHolder<Block, ChaliceBlock> GREAT_CHALICE = BLOCKS.register("great_chalice", () -> new ChaliceBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_ORANGE).requiresCorrectToolForDrops().strength(3.0F, 6.0F).sound(SoundType.COPPER).lightLevel(state -> state.getValue(ChaliceBlock.fill).equals(5) ? 5 : 0))
            {
                @Override

...
public class KnightQuestWeapons {
    ...
    public static final RegistryObject<Item> CLEAVER = register("cleaver_heavy_axe", () -> new CleaverWeapon(KQItemMaterials.CLEAVER, -1, -3.2f, new Item.Properties().tab(KnightQuest.CREATIVE_MODE_TAB)));
